...
window.locales['ko-KR'] = {
  ...
  // menu list
  'menu.Settings': '설정',
  'menu.B2BJobAssort': 'DAS 분류',
  'menu.DasJobAssort': 'DAS 분류',
  'menu.B2CPickingJob': 'DPS 피킹',
  'menu.B2BSkuInput': '상품 투입',
  'menu.B2BSkuInput2': '상품 투입',
  'menu.B2CBoxInput': '박스 투입',
  'menu.B2CBoxRequirement': '박스 소요량',
  'menu.B2BAssortJob': 'DAS 분류',
  'menu.B2BRtnAssortJob': '반품 분류',
  ...
  'menu.PdaRackInputList': 'DAS 투입목록',
  ...
  'menu.CellBoxMapping': '셀 매핑',
  'menu.B2CPickSinglePack': '단포 작업',
  'menu.PackingCheck': '포장 작업',
  'menu.TabletBoxCellMappingStatus': '셀 매핑현황',
